...
sk_sp<SkSurface> MakeSkSurface(const ui::gfx::ImageInfo& image_info,
...
class HostSkSurfacePool {
 public:
  ...
  const ui::gfx::ImageInfo* image_info() const {
  ...
  bool Configure(const ui::gfx::ImageInfo* image_info);
