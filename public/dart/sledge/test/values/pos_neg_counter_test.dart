...
void main() {
  ...
  test('PosNegCounterValue construction double', () {
    var cnt = new PosNegCounterValue<double>(1, [
      new KeyValue(intConverter.serialize(2), doubleConverter.serialize(4.25)),
      new KeyValue(intConverter.serialize(3), doubleConverter.serialize(3.0)),
      new KeyValue(intConverter.serialize(6), doubleConverter.serialize(2.5)),
      new KeyValue(intConverter.serialize(9), doubleConverter.serialize(4.125))
    ]);
