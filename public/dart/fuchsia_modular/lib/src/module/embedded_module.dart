...
/// a [views.ViewHolderToken] object. The combination of these objects can be
/// used to embed the new module's view into your own view hierarchy.
class EmbeddedModule {
  ...
  /// screen.
  final views.ViewHolderToken viewHolderToken;
