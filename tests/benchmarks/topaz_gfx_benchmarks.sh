...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${BENCHMARK}"                           \
    "set_root_view image_grid_flutter" --unshadowed --clipping_disabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "set_root_view image_grid_flutter" --unshadowed --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "set_root_view image_grid_flutter" --screen_space_shadows --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "set_root_view image_grid_flutter" --shadow_map --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "set_root_view image_grid_flutter" --moment_shadow_map --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${IMAGE_GRID_FLUTTER_X3_COMMAND}" --unshadowed --clipping_disabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${IMAGE_GRID_FLUTTER_X3_COMMAND}" --unshadowed --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${IMAGE_GRID_FLUTTER_X3_COMMAND}" --screen_space_shadows --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${IMAGE_GRID_FLUTTER_X3_COMMAND}" --shadow_map --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${IMAGE_GRID_FLUTTER_X3_COMMAND}" --moment_shadow_map --clipping_enabled

# choreography
CHOREOGRAPHY_COMMAND="run device_runner --test --enable_presenter --account_provider=dev_token_manager --device_shell=dev_device_shell --device_shell_args=--test_timeout_ms=60000 --user_shell=dev_user_shell --user_shell_args=--root_module=choreography --story_shell=mondrian"
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${CHOREOGRAPHY_COMMAND}" --unshadowed --clipping_disabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${CHOREOGRAPHY_COMMAND}" --unshadowed --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${CHOREOGRAPHY_COMMAND}" --screen_space_shadows --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${CHOREOGRAPHY_COMMAND}" --shadow_map --clipping_enabled
...
runbench_exec "${OUT_DIR}/${BENCHMARK}.json" \
    ...
    "${OUT_DIR}/${BENCHMARK}.json"           \
    "${BENCHMARK}"                           \
    "${CHOREOGRAPHY_COMMAND}" --moment_shadow_map --clipping_enabled
