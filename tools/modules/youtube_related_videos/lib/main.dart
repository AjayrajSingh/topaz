...
Future<Null> main() async {
  ...
  ModuleWidget<YoutubeRelatedVideosModuleModel> moduleWidget =
      new ModuleWidget<YoutubeRelatedVideosModuleModel>(
    applicationContext: new ApplicationContext.fromStartupInfo(),
    moduleModel: new YoutubeRelatedVideosModuleModel(),
    child: new YoutubeRelatedVideosScreen(apiKey: googleApiKey),
  );
