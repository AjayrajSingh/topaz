...
Future<Null> main() async {
  ...
  ModuleWidget<YoutubeThumbnailModuleModel> moduleWidget =
      new ModuleWidget<YoutubeThumbnailModuleModel>(
    applicationContext: new ApplicationContext.fromStartupInfo(),
    moduleModel: new YoutubeThumbnailModuleModel(),
    child: new YoutubeThumbnailScreen(apiKey: googleApiKey),
  );
